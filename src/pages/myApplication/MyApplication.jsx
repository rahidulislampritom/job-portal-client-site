...
const MyApplication = () => {
    ...
    useEffect(() => {
        // fetch(`http://localhost:6900/job-application?email=${user.email}`)
        //     .then((res) => res.json())
        //     .then((data) => {
        //         setJobs(data)
        //         // console.log(data)
        ...
        // axios.get(`http://localhost:6900/job-application?email=${user.email}`, { withCredentials: true })
    ...
    const handleDelete = (id) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch(`http://localhost:6900/job-application/${id}`, {
                    method: 'DELETE'
                })
                    .then(res => res.json())
                    .then(data => {
